...
const EmailBody = ({id, mailBodyData }) => {
  ...
  return (
    <>
      {mailBodyData?.length>0 ? (
        mailBodyData?.map((data) => {
          return (
            <div
              className="text-white col-span-6 border-l-2 border-solid border-zinc-950 "
            ...
            >
              ...
              <div
                className="p-4 ms-1 scrollable-grid-container"
